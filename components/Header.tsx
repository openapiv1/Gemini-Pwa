          ...
          <div className="relative" ref={dropdownRef}>
            <div className="flex items-center justify-start h-8">
              <button
                ...
                className="flex items-center gap-1 text-lg sm:text-xl text-black dark:text-white"
              >
            ...
            {isOpen && (
              <div className="absolute top-full mt-2 w-max bg-white dark:bg-[#212121] rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800 z-10">
                <ul className="py-1">
                  {models.map((model) => (
                    <li
                      key={model}
